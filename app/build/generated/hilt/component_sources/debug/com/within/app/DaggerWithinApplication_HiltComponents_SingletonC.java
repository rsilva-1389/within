...
public final class DaggerWithinApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends WithinApplication_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(MapBuilder.<String, Boolean>newMapBuilder(4).put(LazyClassKeyProvider.com_within_app_ui_home_HomeViewModel, HomeViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_within_app_ui_navigation_NavigationViewModel, NavigationViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_within_app_ui_onboarding_OnboardingViewModel, OnboardingViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_within_app_ui_settings_SettingsViewModel, SettingsViewModel_HiltModules.KeyModule.provide()).build());
    }
  ...
  private static final class ViewModelCImpl extends WithinApplication_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.navigationViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 1);
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(MapBuilder.<String, javax.inject.Provider<ViewModel>>newMapBuilder(4).put(LazyClassKeyProvider.com_within_app_ui_home_HomeViewModel, ((Provider) homeViewModelProvider)).put(LazyClassKeyProvider.com_within_app_ui_navigation_NavigationViewModel, ((Provider) navigationViewModelProvider)).put(LazyClassKeyProvider.com_within_app_ui_onboarding_OnboardingViewModel, ((Provider) onboardingViewModelProvider)).put(LazyClassKeyProvider.com_within_app_ui_settings_SettingsViewModel, ((Provider) settingsViewModelProvider)).build());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 1: // com.within.app.ui.navigation.NavigationViewModel 
          return (T) new NavigationViewModel(singletonCImpl.userPreferencesProvider.get());

          case 2: // com.within.app.ui.onboarding.OnboardingViewModel 
          return (T) new OnboardingViewModel(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.userPreferencesProvider.get(), singletonCImpl.notificationSchedulerProvider.get());

          case 3: // com.within.app.ui.settings.SettingsViewModel 
  ...
  private static final class SingletonCImpl extends WithinApplication_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.messageRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<MessageRepository>(singletonCImpl, 2));
    }
    ...
    private NotificationReceiver injectNotificationReceiver2(NotificationReceiver instance) {
      NotificationReceiver_MembersInjector.injectMessageRepository(instance, messageRepositoryProvider.get());
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 2: // com.within.app.data.repository.MessageRepository 
